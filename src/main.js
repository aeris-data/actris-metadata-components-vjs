...
import ActrisMetadataLayout from './actris-metadata-layouts/actris-metadata-layout.vue';
...
ljs.load('dep', function() {
	...
	function register() {
		...
		if (window.registredAerisElements.indexOf("aeris-metadata-components-vjs") > -1) {
			...
			Vue.component('actris-metadata-layout', ActrisMetadataLayout);
			registerElement('actris-metadata-layout', ActrisMetadataLayout);
